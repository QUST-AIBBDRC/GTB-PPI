...
label=data[:,0]
data_2=kernelPCA(shu,percentage=0.90)
#the rate of contribution is o.9
shu=data_2
X=shu[index,:]
y=label[index]
sepscores = []
...
yscore_sum.to_csv('yeast_yscore_sum_KPCA_90.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('yeast_ytest_sum_KPCA_90.csv')
...
data_csv.to_csv('yeast_result_KPCA_90.csv')
